...
<script src="js_function/doctor_login.js" type="text/javascript" language="javascript"></script>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav ml-auto nav-size lead">
     <li class="nav-item">
      ...
      <li class="nav-item ">
         <a class="nav-link white-text"  href="#" id="item2"><strong><img src="icon/manage_appointment.png" style="margin-bottom:8px;"> MANAGE APPOINTMENT</strong></a>
      </li>
    </ul>
  </div>
</nav>
...
<div class="container">
    ...
    <div class="col-lg-5 col-md-12 col-sm-8 col-xs-12 mx-auto" >
      <div class="card card-body account-wall p-4">
         <h1 class="lead  mx-auto p-4"  style="font-size: 2em; padding-bottom: 20px"><img src="icon/doctor_login.png" style="margin-bottom:8px;"> DOCTOR'S LOGIN</h1>
